...
var EasyPostService = /** @class */ (function () {
    ...
    EasyPostService.prototype.buyShipment = function (request) {
        return this.http.post(this.baseUrl +
...
var ShipmentFormComponent = /** @class */ (function () {
    function ShipmentFormComponent(http, easyPostService) {
        this.http = http;
        this.easyPostService = easyPostService;
        this.displayedColumns = ['select', 'carrier', 'service', 'rate', 'currency', 'retail_rate', 'retail_currency', 'list_rate', 'list_currency'];
        this.weight = {
            lbs: null,
            oz: null
        };
    ...
    ShipmentFormComponent.prototype.selectRate = function (rate) {
        this.selectedRate = rate;
    };
    ShipmentFormComponent.prototype.buyShipment = function () {
        var _this = this;
        this.easyPostService.buyShipment({
            ...
            console.log(result);
            _this.label_url = result.postage_label.label_url;
            console.log(_this.label_url);
        });
    };
